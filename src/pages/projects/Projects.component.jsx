...
function Projects ({auth, reduxProjects}) {
  ...
  const editPostInputs = (postObj) => {
    ...
    if (reduxProjects !== null) {
      ...
      const currentProjects = !auth ? projectsArr.slice(indexOfFirstProject, indexOfLastProject) : projectsArr;
      ...
      <div>
        <div className="project_container">
          ...
          {!auth && <Pagination 
           ...
           total={reduxProjects !== null && Object.keys(reduxProjects).length}/>}
           </div>
        </div>
        <Footer />
      </div>
